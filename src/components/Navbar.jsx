...
import { FaCode ,FaCentercode, FaUnsplash  } from "react-icons/fa";
...
const Navbar = ({ hidden = false }) => {
  ...
  return (
    <nav className="navbar max-w-7xl mx-auto relative z-50 py-7 flex items-center justify-between px-6 md:px-12">
      {/* Logo */}
      <div className="logo flex items-center gap-2">
        <span className="w-5 h-5 text-[#1a96a9] "> <FaUnsplash className="text-2xl"/> </span>
        <h1 className="text-3xl font-bold bebas-neue-regular text-white  md:bg-transparent md:text-white">
          Sairaj Naiwade
        </h1>
      </div>
