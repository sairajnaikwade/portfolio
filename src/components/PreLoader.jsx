...
const PreLoader = () => {
  ...
  // Fallback in case the count animation never triggers (e.g., intersection observer doesn't fire)
  useEffect(() => {
    // Ensure the preloader never blocks forever (e.g., if animation fails)
    const fallbackTimer = setTimeout(() => setCountDone(true), 2000)
